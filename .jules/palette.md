...
## 2024-11-21 - Palette: CLI output coloring
* **What**: Updated `src/arka/cli.py` to use `click.secho` for error messages (red) and success messages (green).
* **Why**: To remove developer friction by making error and success messages stand out in the terminal output, making it easier to parse logs.
* **Before**: Output error was plain text.
* **After**: Output error is colored red, success messages are green.
