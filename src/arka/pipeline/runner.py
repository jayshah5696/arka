        ...
        try:
            for i, stage in enumerate(stages, 1):
                ...
                try:
                    ...
                    # DX: Wrap stage failures with the stage name and record loss count to improve error visibility in CLI
                    raise RuntimeError(
                        f"Stage '{stage.name}' failed. {count_in} records were lost - {exc}"
                    ) from exc
