...
class CheckpointManager:
    def __init__(self, sqlite_path: Path) -> None:
        ...
        # PERF: Optimize SQLite checkpointing by using WAL mode, synchronous=NORMAL, and a single persistent connection across stage writes. Expected impact: 20-40% checkpoint speedup by reducing reconnect latency and lock contention.
