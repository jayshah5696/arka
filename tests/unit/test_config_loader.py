...
def test_yaml_syntax_error_includes_filename(tmp_path: Path) -> None:
    ...
    # DX: Verify that the exact line and column of the syntax error are correctly extracted and reported
    assert "at line 3, column 7: could not find expected ':'" in str(exc.value)
