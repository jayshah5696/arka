...
from arka.config.models import ResolvedConfig, CanaryFilterConfig, SeedSourceConfig, FiltersConfig
...
def test_get_stage_config_resolution() -> None:
    ...
    res_legacy = stage.get_stage_config(ctx_legacy, CanaryFilterConfig, legacy_field="canary")
    ...
    res_fallback = stage.get_stage_config(ctx_dummy, SeedSourceConfig, default_val=fallback_val)
